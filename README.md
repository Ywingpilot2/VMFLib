Experimental branch for testing in Net 7.0. I have not worked with Net7 very much, so a program as simple as this I thought would be a fun way to test the differences!
